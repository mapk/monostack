...
function monostack_scripts() {
	...
	if ( !is_404() ) {
		...
		wp_localize_script( 'monostack-syntax-highlighting', 'translateWords', array(
            'about'   => __( 'about', 'monostack' ),
            'beside'   => __( 'beside', 'monostack' ),
            'near'   => __( 'near', 'monostack' ),
            'to'   => __( 'to', 'monostack' ),
            'above'   => __( 'above', 'monostack' ),
            'between'   => __( 'between', 'monostack' ),
            'of'   => __( 'of', 'monostack' ),
            'towards'   => __( 'towards', 'monostack' ),
            'across'   => __( 'across', 'monostack' ),
            'beyond'   => __( 'beyond', 'monostack' ),
            'off'   => __( 'off', 'monostack' ),
            'under'   => __( 'under', 'monostack' ),
            'after'   => __( 'after', 'monostack' ),
            'by'   => __( 'by', 'monostack' ),
            'on'   => __( 'on', 'monostack' ),
            'underneath'   => __( 'underneath', 'monostack' ),
            'against'   => __( 'against', 'monostack' ),
            'despite'   => __( 'despite', 'monostack' ),
            'onto'   => __( 'onto', 'monostack' ),
            'unlike'   => __( 'unlike', 'monostack' ),
            'along'   => __( 'along', 'monostack' ),
            'down'   => __( 'down', 'monostack' ),
            'opposite'   => __( 'opposite', 'monostack' ),
            'until'   => __( 'until', 'monostack' ),
            'among'   => __( 'among', 'monostack' ),
            'during'   => __( 'during', 'monostack' ),
            'out'   => __( 'out', 'monostack' ),
            'up'   => __( 'up', 'monostack' ),
            'around'   => __( 'around', 'monostack' ),
            'except'   => __( 'except', 'monostack' ),
            'outside'   => __( 'outside', 'monostack' ),
            'upon'   => __( 'upon', 'monostack' ),
            'as'   => __( 'as', 'monostack' ),
            'for'   => __( 'for', 'monostack' ),
            'over'   => __( 'over', 'monostack' ),
            'via'   => __( 'via', 'monostack' ),
            'at'   => __( 'at', 'monostack' ),
            'from'   => __( 'from', 'monostack' ),
            'past'   => __( 'past', 'monostack' ),
            'with'   => __( 'with', 'monostack' ),
            'before'   => __( 'before', 'monostack' ),
            'in'   => __( 'in', 'monostack' ),
            'round'   => __( 'round', 'monostack' ),
            'within'   => __( 'within', 'monostack' ),
            'behind'   => __( 'behind', 'monostack' ),
            'inside'   => __( 'inside', 'monostack' ),
            'since'   => __( 'since', 'monostack' ),
            'without'   => __( 'without', 'monostack' ),
            'below'   => __( 'below', 'monostack' ),
            'into'   => __( 'into', 'monostack' ),
            'than'   => __( 'than', 'monostack' ),
            'beneath'   => __( 'beneath', 'monostack' ),
            'like'   => __( 'like', 'monostack' ),
            'through'   => __( 'through', 'monostack' ),
        ) );
	}
